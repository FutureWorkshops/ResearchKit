...
public class CurrencyFormatter: NSObject, CurrencyFormatting {
    ...
    @objc public var nsLocale: NSLocale {
        set { self.numberFormatter.locale = newValue as Locale }
        get { self.numberFormatter.locale as NSLocale }
    }
    ...
    @objc public let numberFormatter: NumberFormatter
    ...
    @objc public init(_ handler: InitHandler? = nil) {
...
extension CurrencyFormatter {
    ...
    @objc public func string(from double: Double) -> String? {
    ...
    /// - Parameter string: string that describes the numerical value.
    /// - Returns: the value as a Double.
    @objc public func doubleAsNSNumber(from string: String) -> NSNumber? {
        if let double = self.double(from: string) {
    ...
    @objc public func unformatted(string: String) -> String? {
